...
const CarouselWrapper = ({children, items, mode, showControls, loop}:any) => {
    ...
    const rpc_content:any = useRef(), rpc_content_wrapper:any = useRef(), rpc_content_wrapper_stage:any = useRef();
    ...
    const creepToPosition = (mainFactor:any) => {
    ...
    const skipToPosition = (mainFactor:any) => {
        rpc_content_wrapper_pos_x = mainFactor;
        drag_up_val = rpc_content_wrapper_pos_x;
        rpc_content_wrapper.current.style.transition = '0s';
        rpc_content_wrapper.current.style.transform = `translateX(${rpc_content_wrapper_pos_x}px)`;
    ...
    const setDrag = (isDrag:any, e:any) => {
        isDragging = isDrag;
        if(isDrag) {
